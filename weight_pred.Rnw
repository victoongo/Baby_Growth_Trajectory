...
par(mfrow = c(1, 1), oma = c(4, 4, 0, 4), mar=c(0,0,0,0))
plot(m11f, y2par=list(col='black'), yfun=exp, xlab="Age in Months", ylab="Weight (kg)", apv=T, mar=c(0,0,0,0), axes=T, y2axis=TRUE, axispar(col = "grey40", col.axis = "grey20", at = seq(0.2,1.2,0.2)))


# axis(4, col = "grey40", col.axis = "grey20", at = seq(0.2,1.2,0.2), tck=1)
